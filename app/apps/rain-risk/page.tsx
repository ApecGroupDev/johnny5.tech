...
export default async function RainRiskPage() {
    ...
    <div className="relative">
      <Container>
          ...
          <div className="mt-6 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-muted md:text-lg">
                Multi-model rain consensus for construction scheduling — scored
                on your work hours.
              </p>
            </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 border-t border-line pt-8 md:grid-cols-3">
          ...
          <Info label="Category" value="Construction" />
          <Info label="Data" value="Browser-only (localStorage)" />
        </div>
